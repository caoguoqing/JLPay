...
- (id)initWithGivenDataElements:(NSArray *)dataElements configFileName:(NSString *)configFileName {
    ...
    if (self) {
        _isBinary = YES;
        NSString *pathToConfigFile = !configFileName ? [[NSBundle mainBundle] pathForResource:@"newisoconfig" ofType:@"plist"] : [[NSBundle mainBundle] pathForResource:configFileName ofType:@"plist"];
...
- (NSArray *)dataElementsInBitmap:(NSString *)customConfigFileName {
    NSString *pathToConfigFile = !customConfigFileName ? [[NSBundle mainBundle] pathForResource:@"newisoconfig" ofType:@"plist"] : [[NSBundle mainBundle] pathForResource:customConfigFileName ofType:@"plist"];
    NSDictionary *dataElementsScheme = [NSDictionary dictionaryWithContentsOfFile:pathToConfigFile];
