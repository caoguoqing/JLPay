...
#define TranType_BarCode_Trans_Alipay       @"TranType_BarCode_Trans_Alipay__"           // 条形码收款: 支付宝
#define TranType_BarCode_Trans_WeChat       @"TranType_BarCode_Trans_WeChat__"           // 条形码收款: 微信
#define TranType_BarCode_Review_Alipay      @"TranType_BarCode_Review_Alipay__"          // 条形码收款结果查询: 支付宝
#define TranType_BarCode_Review_WeChat      @"TranType_BarCode_Review_WeChat__"          // 条形码收款结果查询: 微信
