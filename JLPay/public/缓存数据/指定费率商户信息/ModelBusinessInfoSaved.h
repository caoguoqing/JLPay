...
static NSString* const MBusinessInfoRateType_38 = @"民生类"; //0
static NSString* const MBusinessInfoRateType_78_normal = @"一般类";//1
static NSString* const MBusinessInfoRateType_78_whole = @"批发类";//2
static NSString* const MBusinessInfoRateType_125_food = @"餐饮类";//3
